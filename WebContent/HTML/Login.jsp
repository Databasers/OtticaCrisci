...
<form id="login"  method="Post">
	...
	<input type="submit" formaction="http://localhost:8080/OtticaCrisci/GestioneLogin?action=login">
	<input type="submit" formaction="http://localhost:8080/OtticaCrisci/GestioneLogin?action=loginAdmin" value="Login as Admin">
